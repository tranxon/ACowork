 ...
 *
 * Backed by Gateway ripgrep for full-text search across all files in the
 * workspace. For LSP-aware symbol search (functions, classes, variables),
 * use Ctrl+T which opens the dedicated SymbolSearchPanel.
 */
...
export function GlobalSearchPanel({
    ...
    /** Union nav item: text match or file header. */
    type NavItem =
    ...
    const grouped = useMemo(() => {
        ...
        // Sort matches within each file by line
            ...
            switch (e.key) {
                ...
                case "Enter": {
                    ...
                    if (item.kind === "match") {
                        ...
                        // File header — open first match in the group
