...
//! Grafeo (rollball-grafeo) is the primary implementation.

use std::time::Duration;

use rollball_core::error::Result;
...
pub trait MemoryStore: Send + Sync {
    ...
    ///
    /// Automatically classifies content type (Informational/Artifact/Structural).
    /// Artifact content is compressed to summary + ArtifactRef.
