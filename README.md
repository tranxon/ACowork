...
| [12-tool-system.md](./docs/12-tool-system.md) | 工具系统：Built-in Tools、WASM 沙箱（Wasmtime）、Host-WASM 通信、Gateway Tools、平台兼容性 |
| [13-skill-system.md](./docs/13-skill-system.md) | 技能系统：SKILL.md 格式、Grafeo 经验层、自学习闭环、调试模式、模型兼容性 |
