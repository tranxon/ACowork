...
- **语义记忆（LPG 知识图谱）**：存储从交互中提取的结构化知识（事实、偏好、关系），以及 Skill 系统的草稿、迭代、执行记录和经验数据。
...
| 节点类型 | 用途 | 详见 |
|---------|------|------|
| KnowledgeNode | 事实、偏好、关系 | 本文档 |
| SkillDraft | 草稿 Skill（调试阶段） | [13-skill-system.md](./13-skill-system.md) 第 3.2 节 |
| SkillIteration | 迭代版本快照 | [13-skill-system.md](./13-skill-system.md) 第 3.3 节 |
| SkillExecution | 执行记录（含模型信息） | [13-skill-system.md](./13-skill-system.md) 第 3.4 节 |
| SkillExperience | 已发布 Skill 的运行经验 | [13-skill-system.md](./13-skill-system.md) 第 3.5 节 |
